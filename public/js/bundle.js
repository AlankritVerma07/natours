...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF2cmlja2h1bnQiLCJhIjoiY2tmdm1pcTR5MTRheDJwbHJzeXFrd3Q3aSJ9.TZX24PcZgQb-XFb59pC1vw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mavrickhunt/ckfw8spec7dy519k2n9wwl1lo',
    scrollZoom: false //   centre: [-118.113491, 34.111745],
...
var stripe = Stripe('pk_test_51Hc7cICXP0z1fpQgUiteOmC3BQcNHVTNfSBtV3o6smdeadV9XFOhfw0QlHQgqA5aHuWgNrRIztXyUW38SxIcV8Ls00oCmLNlOs');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            //Clear the i/p fields once the passwords are updated
